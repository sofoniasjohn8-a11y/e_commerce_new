  ...
  return (
    <Layout>
        ...
        <div className="row mb-5">
            ...
            <h4 className='h4  mb-0'>Products</h4>
            ...
            <div className="card shadow">
              ...
              {
                products.length == 0 && loading == false && <Nostate text="Products Not Found"/>
              }
              {
                ...
                <table className="table">
                  ...
                  <tbody>
                    {products.map((product) => (
                      ...
                      {
                            !product.image_url ? (
                                <img src="https://placehold.co/600x400" alt="Placeholder" width="50" />
                            ) : (
                        ...
                        <td>{product.qty}</td>
                        <td>{product.sku}</td>
                        <td>{product.status == 1 ? <span className="badge bg-success">Active</span> : <span className="badge bg-danger">Block</span>}</td>
                       <td>
